...
export default function Cabins() {
  ...
  return (
    <>
      <section id="cabins" ref={sectionRef} className="relative overflow-hidden px-6 py-24 md:py-32 lg:py-40">
        <div ref={bgRef} className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-b from-white via-sky-50/30 to-white" />

        <div className="mx-auto max-w-7xl">
          <div data-section-heading className="mb-12 text-center">
            <span data-heading-anim className="inline-block text-xs font-semibold uppercase tracking-[0.2em] text-sky-500 mb-4">Accommodations</span>
            <h2 data-heading-anim className="text-4xl font-bold text-slate-900 md:text-5xl lg:text-6xl">Cabins &amp; Suites</h2>
            <p data-heading-anim className="mx-auto mt-4 max-w-2xl text-lg text-slate-500">
              Every cabin is a sanctuary of comfort and elegance, designed to make your stay as memorable as the destinations.
            </p>
          </div>

          <CinematicCarousel sectionRef={carouselSectionRef} showDots={false}>
            {allImages.map((img, i) => (
              <button
                key={i}
                data-cabin-card
